...
class GeneratorTest < Test::Unit::TestCase
  ...
  def test_feed
    ...
    assert_equal("{\"id\":\"id:ns:type::0\", \"text\":\"one one\", \"chars\": \"on\", \"ints\": [1, 1], \"floats\": 0.6007954689329611, \"filter\": [90]}\n",
                 `#{feed_command}`)
  end
  ...
  def test_query
    ...
    assert_equal("/search/?query=sddocname%3Atest+foo%3Ared+bar%3Atwitter&a=b\n" +
  ...
  def test_url
    ...
    assert_equal("/document/v1/ns/type/docid/0?%25=%25&c=d\n",
                 `#{url_command}`)
  end
