...
class TestCase
  ...
  def initialize(cmdline, tc_file, args={})
    ...
    @ignorable_messages = [
      ...
      @@log_messages[:slf4j_found_binding],
      @@log_messages[:slf4j_actual_binding],
      @@log_messages[:slf4j_see_multiple_bindings],
  ...
  @@log_messages = {
    ...
    :slf4j_found_binding => /SLF4J: Found binding in/,
    :slf4j_actual_binding => /SLF4J: Actual binding is of type/,
    :slf4j_see_multiple_bindings => /SLF4J: See http:\/\/www.slf4j.org\/codes.html#multiple_bindings/,
    :slf4j_class_path_multiple_bindings => /SLF4J: Class path contains multiple SLF4J bindings/,
