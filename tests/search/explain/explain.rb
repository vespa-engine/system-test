...
class Explain < IndexedSearchTest
  ...
  def verify_to_dispatch(result)
    ...
    assert_match(/sc0.num0 search to dispatch: query=\[\[documentmetastore\]:\*music\*\] timeout=[0-9]+ms offset=0 hits=1 groupingSessionCache=true sessionId=qrserver.0.[0-9]+.[0-9].default grouping=0 :  restrict=\[music\]/, to_dispatch)
  end
