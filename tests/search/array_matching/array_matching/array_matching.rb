...
class ArrayMatching < IndexedSearchTest
  ...
  def test_array_match
    ...
    assert_hitcount("/?query=IDs:1%20IDs:5", 1)
    assert_hitcount("/?query=(IDs:1%20IDs:5)", 5)
    result = search("/?query=(IDs:1!200%20IDs:2%20IDs:3%20IDs:4%20IDs:5)&hits=5");
