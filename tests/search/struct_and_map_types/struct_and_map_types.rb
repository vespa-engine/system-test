...
class StructAndMapTypesTest < IndexedStreamingSearchTest
  ...
  def test_filtered_elements_in_document_summary
    ...
    assert_same_element_summary("elem_map_2", "key contains '@bar', value.weight contains '20'", "filtered", "elem_map_2_filtered", {"@bar" => elem("bar", 20)})
    ...
    assert_same_element_single_summary("elem_map_2", "key contains '@bar'", "filtered", "elem_map_2_filtered", {"@bar" => elem("bar", 20)})
