...
class SearchTimeoutTest < IndexedSearchTest
  ...
  def test_timeout_long_firstphase
    ...
    assert_result_withtimeout(20.0, "query=sddocname:banana&hits=1&nocache", selfdir + "result.1.xml")
    ...
    assert_hitcount_withouttimeout("query=sddocname:banana&hits=1&nocache&timeout=20.0", 20)
