...
class EmptyFieldsInResponseTest < IndexedStreamingSearchTest
  ...
  def normal_values(is_search)
    ...
    empty_wset = []
    {
      ...
      "array_non_attribute_filtered" => is_search ? empty_array : [42, 144],
      "weightedset_attribute_filtered" => is_search ? empty_wset : { "a" => 1 },
      "weightedset_non_attribute_filtered" => is_search ? empty_wset : { "a" => 1 },
  ...
  def assert_fields(hit, accessor, doc, get_fn, expected)
    fields = [
      ...
      "array_non_attribute_filtered",
      "weightedset_attribute_filtered",
      "weightedset_non_attribute_filtered",
