...
class CommonAnnBaseTest < PerformanceTest
  ...
  def calc_recall_for_queries(target_hits, explore_hits, filter_percent = 0, approximate_threshold = 0.05, filter_first_threshold = 0.0, filter_first_exploration = 0.01, slack = 0.0, doc_type = "test", doc_tensor = "vec_m16", query_tensor = "q_vec")
