...
class ReindexingAndFeedingTest < PerformanceTest
  ...
  def graph_config
	...
	'feeder.throughput'     =>   { }
      ...
      { :legend => 'reindex' } => {
	'reindexing.throughput' =>   { :y_min =>  15000, :y_max => 2300 },
      },
      { :legend => 'feed' } => {
	'feeder.throughput'     =>   { :y_min =>  7500, :y_max =>  9000 },
      },
      { :legend => 'reindex_feed' } => {
	'reindexing.throughput' =>   { :y_min =>  1400, :y_max =>  2200 },
	'feeder.throughput'     =>   { :y_min =>  6500, :y_max =>  9000 },
      },
      { :legend => 'update' } => {
	'feeder.throughput'     =>   { :y_min => 32000, :y_max => 42000 },
      },
      { :legend => 'reindex_update' } => {
	'reindexing.throughput' =>   { :y_min =>  1500, :y_max =>  2100 },
	'feeder.throughput'     =>   { :y_min => 24000, :y_max => 30000 },
      }
    }
  end
