...
class MixedTensorFeedSinglePerfTest < MixedTensorPerfTestBase
  ...
  def get_graphs_vec_256
    [
      ...
      get_feed_throughput_graph(PUTS, NUMBER, 4250, 5700),
      get_feed_throughput_graph(PUTS, STRING, 4350, 5700),
      get_feed_throughput_graph(UPDATES_ASSIGN, NUMBER, 4200, 6000),
      get_feed_throughput_graph(UPDATES_ASSIGN, STRING, 4200, 6000),
      get_feed_throughput_graph(UPDATES_ADD, NUMBER, 11000, 15000),
      get_feed_throughput_graph(UPDATES_ADD, STRING, 11000, 15000),
      get_feed_throughput_graph(UPDATES_REMOVE, NUMBER, 22000, 30000),
      get_feed_throughput_graph(UPDATES_REMOVE, STRING, 22000, 30000)
    ]
  end
  ...
  def get_graphs_vec_32
    [
      get_all_feed_throughput_graphs,
      get_feed_throughput_graph(PUTS, NUMBER, 1600, 1800),
      get_feed_throughput_graph(PUTS, STRING, 1400, 1800),
      get_feed_throughput_graph(UPDATES_ASSIGN, NUMBER, 1500, 1800),
      get_feed_throughput_graph(UPDATES_ASSIGN, STRING, 1250, 1800),
      get_feed_throughput_graph(UPDATES_ADD, NUMBER, 16000, 18000),
      get_feed_throughput_graph(UPDATES_ADD, STRING, 16000, 18000),
      get_feed_throughput_graph(UPDATES_REMOVE, NUMBER, 16500, 20000),
      get_feed_throughput_graph(UPDATES_REMOVE, STRING, 16500, 20000)
    ]
  end
