...
class WeightedSetFeedTest < PerformanceTest
  ...
  def parameter_combinations
    [
      ...
      params(1000,   false, 6, 38),
      params(10000,  false, 27, 60),
      params(100000, false, 250, 600),
      params(10,     true, 8, 12),
      params(100,    true, 15, 100),
      params(1000,   true, 140, 200),
      params(10000,  true, 1850, 2200),
      params(100000, true, 15000, 16200)
    ]
  end
