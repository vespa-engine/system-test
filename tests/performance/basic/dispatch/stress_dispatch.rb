...
class StressDispatch < PerformanceTest
  ...
  def common_limits
    l = {
       :min_qps_search          => 10100,
       :max_qps_search          => 12800,
       :min_latency_search      => 5.3,
       :max_latency_search      => 6.1
    }
    return l
  end
  ...
  def common_limits_protobuf
    l = {
       :min_qps_search          => 11000,
       :max_qps_search          => 12500,
       :min_latency_search      => 5.4,
       :max_latency_search      => 6.2
    }
    return l
  end
