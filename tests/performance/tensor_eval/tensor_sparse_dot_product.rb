...
class TensorSparseDotProductTest < TensorEvalPerfTest
  ...
  def get_graphs_dot_product
    [
      ...
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT,         "50x250", 70.0,  71.0),
      ...
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "50x250", 72.0,  74.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "250x50", 36.0,  37.2),
      get_latency_graph_for_rank_profile(STRING_FEATURE_DP,           "50x50",  16.2,  16.9),
