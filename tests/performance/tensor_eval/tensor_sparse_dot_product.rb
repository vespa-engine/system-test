...
class TensorSparseDotProductTest < TensorEvalPerfTest
  ...
  def get_graphs_dot_product
    [
      ...
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT,         "50x250", 20.0,  23.0),
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT,         "250x50",  5.0,   6.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "50x50",  20.0,  26.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "50x10",   6.0,  11.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "10x50",  11.0,  16.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "50x250", 20.0,  24.0),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,   "250x50", 14.0,  19.0),
      get_latency_graph_for_rank_profile(STRING_FEATURE_DP,           "50x50",   5.5,   8.0),
      ...
      get_latency_graph_for_rank_profile(STRING_FEATURE_DP,           "50x250", 20.0,  26.0),
