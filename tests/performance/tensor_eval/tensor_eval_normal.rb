...
class TensorEvalNormalPerfTest < TensorEvalPerfTest
  ...
  def get_graphs_dot_product
    [
      ...
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT,              250, 17.5, 19.1),
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT_ARRAY,        500, 15.5, 17.2),
      get_latency_graph_for_rank_profile(DENSE_TENSOR_DOT_PRODUCT,         500, 16.5, 18.6),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,        250, 650, 685)
    ]
  end
