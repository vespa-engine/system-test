...
class TensorEvalNormalPerfTest < TensorEvalPerfTest
  ...
  def get_graphs_dot_product
    [
      ...
      get_latency_graph_for_rank_profile(FEATURE_DOT_PRODUCT_ARRAY,        500,  15.0,  17.5),
      get_latency_graph_for_rank_profile(DENSE_TENSOR_DOT_PRODUCT,         500,  16.5,  19.5),
      get_latency_graph_for_rank_profile(SPARSE_TENSOR_DOT_PRODUCT,        250, 115  , 120)
    ]
  end
