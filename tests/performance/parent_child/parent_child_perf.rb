...
class ParentChildPerfTest < PerformanceTest
  ...
  def get_graphs
    [
      ...
      get_feeding_graph(FEEDING_PUT, 24000, 29000),
      get_feeding_graph(FEEDING_UPDATE, 26500, 35000),
      get_latency_graph(RANKING, SLOW, 88, 105),
      get_latency_graph(MATCHING, SLOW, 1.6, 2.0),
      get_latency_graph(MATCHING, FAST, 1.02, 1.30)
    ]
  end
