...
class ParentChildPerfTest < PerformanceTest
  ...
  def get_graphs
    [
      ...
      get_feeding_graph(FEEDING_PUT, 22000, 28000),
      get_feeding_graph(FEEDING_UPDATE, 24000, 32000),
      get_latency_graph(RANKING, SLOW, 75, 85),
      get_latency_graph(MATCHING, SLOW, 1.68, 2.00),
      get_latency_graph(MATCHING, FAST, 1.10, 1.40)
    ]
  end
