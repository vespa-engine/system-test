    ...
    @test_config = [
      ...
      },
      {
        :http2 => {
          ...
          :streams => 8,
          :threads => 1,
          :metrics => {'qps' => {'get' => {:y_min => 11800, :y_max => 13300}, 'post' => {:y_min => 6000, :y_max => 7400}}}
        }
      },
      {
        :http2 => {
      ...
      },
      {
        :http2 => {
          ...
          :streams => 8,
          :threads => 8,
          :metrics => {'qps' => {'get' => {:y_min => 41500, :y_max => 48000}, 'post' => {:y_min => 23500, :y_max => 29500}}}
        }
      },
      {
        :http2 => {
          ...
          :streams => 64,
          :threads => 8,
          :metrics => {'qps' => {'get' => {:y_min => 55000, :y_max => 71000}, 'post' => {:y_min => 29000, :y_max => 47000}}}
        }
      },
      {
        :http2 => {
